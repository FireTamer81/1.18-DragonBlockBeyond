package io.firetamer.dragonblockbeyond._modules.colorable_strongblock_module.client.gui.screen;
...
import io.firetamer.dragonblockbeyond._modules.colorable_strongblock_module.client.gui.widget.ColorSlider;
import io.firetamer.dragonblockbeyond._modules.colorable_strongblock_module.client.gui.widget.SliderType;
...
import io.firetamer.dragonblockbeyond._modules.colorable_strongblock_module.util.network.packets.PaintBucketSyncPKT;
...
public class ColorSelectScreen extends Screen {
    ...
    public ColorSelectScreen(int colorIn, boolean isRGBSelected) {
        ...
        this.useRGBText = new TranslatableComponent("gui.dragonblockbeyond.useRGB");
        this.useHSBText = new TranslatableComponent("gui.dragonblockbeyond.useHSB");
    }
    ...
    protected void init() {
        ...
        if (redSlider == null) {
            this.redSlider = new ColorSlider(x,
                                             ...
                                             SLIDER_WIDTH,
                                             WIDGET_HEIGHT,
                                             new TranslatableComponent("gui.dragonblockbeyond.red").append(": "),
                                             MIN_VALUE,
                                             MAX_VALUE_RGB,
                                             this.red,
                                             SliderType.RED);
        ...
        if (hueSlider == null) {
            this.hueSlider = new ColorSlider(x,
                                             ...
                                             SLIDER_WIDTH,
                                             WIDGET_HEIGHT,
                                             new TranslatableComponent("gui.dragonblockbeyond.hue").append(": "),
                                             MIN_VALUE,
                                             MAX_VALUE_HUE,
                                             this.hue,
                                             SliderType.HUE);
        ...
        if (greenSlider == null) {
            this.greenSlider = new ColorSlider(x,
                                               ...
                                               SLIDER_WIDTH,
                                               WIDGET_HEIGHT,
                                               new TranslatableComponent("gui.dragonblockbeyond.green").append(": "),
                                               MIN_VALUE,
                                               MAX_VALUE_RGB,
                                               this.green,
                                               SliderType.GREEN);
        ...
        if (saturationSlider == null) {
            this.saturationSlider = new ColorSlider(x,
                                                    ...
                                                    SLIDER_WIDTH,
                                                    WIDGET_HEIGHT,
                                                    new TranslatableComponent("gui.dragonblockbeyond.saturation").append(": "),
                                                    MIN_VALUE,
                                                    MAX_VALUE_SB,
                                                    this.saturation,
        ...
        if (blueSlider == null) {
            this.blueSlider = new ColorSlider(x,
                                              ...
                                              SLIDER_WIDTH,
                                              WIDGET_HEIGHT,
                                              new TranslatableComponent("gui.dragonblockbeyond.blue").append(": "),
                                              MIN_VALUE,
                                              MAX_VALUE_RGB,
                                              this.blue,
                                              SliderType.BLUE);
        ...
        if (brightnessSlider == null) {
            this.brightnessSlider = new ColorSlider(x,
                                                    ...
                                                    SLIDER_WIDTH,
                                                    WIDGET_HEIGHT,
                                                    new TranslatableComponent("gui.dragonblockbeyond.brightness").append(": "),
                                                    MIN_VALUE,
                                                    MAX_VALUE_SB,
                                                    this.brightness,
        ...
        this.hexBox = new EditBox(this.font, x, y, BOX_WIDTH, WIDGET_HEIGHT, new TextComponent("Hex")) {
            ...
            public void insertText(String textToWrite) {
                ...
                try {
                    ...
                    DragonBlockBeyond.LOGGER.debug(textToWrite);
                }
            ...
            public void deleteChars(int pNum) {
                ...
                try {
                    ...
                    DragonBlockBeyond.LOGGER.debug(getValue());
                }
                int cursorPosition = this.getCursorPosition();
                this.setValue("#" + (getValue().contains("#") ? getValue().substring(1) : getValue()));
                if (this.getCursorPosition() != cursorPosition) {
