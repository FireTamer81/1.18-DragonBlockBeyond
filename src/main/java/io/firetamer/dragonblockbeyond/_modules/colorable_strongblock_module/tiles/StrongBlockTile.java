...
public class StrongBlockTile extends BlockEntity {
    ...
    public StrongBlockTile(BlockPos pos, BlockState state) {
        super(ColorableStrongBlockModule.STRONG_BLOCK_TILE.get(), pos, state);
        this.color = new Color(242, 242, 242).getRGB();
    }
