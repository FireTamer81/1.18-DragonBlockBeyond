...
public class AnimatedAxeItem extends AxeItem implements IAnimatable, IAnimatedItem {
    ...
    public AnimatedAxeItem(Tier tier, float attackDamageModifier, float attackSpeedModifier, AnimatedItemProperties properties) {
        super(tier, attackDamageModifier, attackSpeedModifier, properties);
        effectSuppliers = properties.getAxeEffectSuppliers();
